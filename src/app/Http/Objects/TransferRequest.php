...
class TransferRequest
{
     ...
     */
    public function __construct(array $destinations, $fee, $mixin, $unlock_time, $payment_id, $address, $view_key, $account_create_time, $local_bc_height, $transfers, $key_images)
    {
